...
class DeathRecordAdminMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Death Record')->view('emails.medical.death-record-admin', compact(  'client_fullname', 'dashboard_link'));
    }
}
