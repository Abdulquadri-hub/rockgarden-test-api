...
class MedicalVisitAdminMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Medical Visit')->view('emails.medical.medical-visit-admin', compact(  'client_fullname', 'dashboard_link'));
    }
}
