...
class MedicationMissedFriendMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $date = $this->date;
        return $this->subject('Medication Missed')->view('emails.medical.medication-missed-friend', compact(  'client_fullname', 'family_friend_name', 'date'));
    }
}
