...
class DocumentClientUpdatedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Staff Assignment')->view('emails.document.document-client-updated', compact('familyfriend_name', 'client_fullname'));
