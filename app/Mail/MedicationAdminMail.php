...
class MedicationAdminMail extends Mailable
{
  ...
  private $client_fullname, $dashboard_link, $date;
    ...
    public function build()
    {
        ...
        $date = $this->date;
        return $this->subject('Medication Intake')->view('emails.medical.medication-admin', compact(  'client_fullname', 'dashboard_link', 'date'));
    }
}
