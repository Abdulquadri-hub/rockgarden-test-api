...
class PrescriptionFriendUpdatedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Prescription')->view('emails.medical.prescription-updated-friend', compact(  'client_fullname', 'family_friend_name', 'medicine_name'));
    }
}
