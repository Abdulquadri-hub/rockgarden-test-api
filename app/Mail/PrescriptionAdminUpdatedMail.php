...
class PrescriptionAdminUpdatedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Prescription')->view('emails.medical.prescription-updated-admin', compact(  'client_fullname', 'dashboard_link', 'medicine_name'));
    }
}
