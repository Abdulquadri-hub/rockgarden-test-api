...
class LoanController extends Controller
{
    ...
    public function indexPaged(Request $request)
    {
        return \response()->json([
            'success' => true,
            'message' => Loan::paginate((int) $request->get('limit'))
        ], Response::HTTP_OK);
    }
    ...
    {
        $loan = Loan::where('id', $request->get('id'))->first();
        return \response()->json([
                'success' => true,
                'message' => $loan
            ]
    ...
    public function update(Request $request)
    {
        try {
            ...
            if($validator->fails()) {
                return response()->json([
                    'success' => false,
                    'message' => 'Invalid loan update information'
                ], Response::HTTP_BAD_REQUEST);
            }

            $loan = Loan::where('id', $request->get('id'))->firstOrFail();
            if(empty($loan)){
                return response()->json([
                    'success' => false,
    ...
    public function destroy(Request $request)
    {
        ...
        Loan::where('id', $request->get('id'))->delete();
