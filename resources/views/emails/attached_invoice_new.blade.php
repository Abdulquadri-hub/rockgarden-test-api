    ...
    <header class="clearfix">
        ...
        <div>
            <div id="company" class="clearfix" style="margin-right: 1rem;">
                ...
                <div><a
                        href="mailto:info@rockgardenhomecareagency.com?subject=&amp;body=">info@rockgardenhomecareagency.com</a>
                </div>
            </div>
            <div id="project">
                <div><span>CLIENT</span> {{$inv_user->first_name}} {{$inv_user->last_name}}</div>
                <table style="margin-bottom: 0;"><tbody><tr><td style="background: initial;padding: 0;text-align: left;width: 65px;"><span style="/*! margin-right: 0; */">ADDRESS</span></td> <td align="right" style="padding: 0;text-align: right;background: initial;">{{$inv_user->home_address}},<br> {{$inv_user->city}}, {{$inv_user->state}}</td></tr></tbody></table>
