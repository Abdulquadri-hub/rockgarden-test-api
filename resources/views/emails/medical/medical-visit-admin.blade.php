...
@section('content')
    <div class="v-text-align" style="line-height: 160%; text-align: justify; word-wrap: break-word;">
        ...
        <p style="font-size: 14px; line-height: 160%;">
            A new medical visit has been recorded for {{$client_fullname}}. Please login to the Rockgarden EHR’s dashboard to view the details.  <a href="{{$dashboard_link}}">{{$dashboard_link}}</a>
        </p>
    </div>
@endsection
