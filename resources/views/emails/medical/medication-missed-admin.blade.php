...
@section('content')
    <div class="v-text-align" style="line-height: 160%; text-align: justify; word-wrap: break-word;">
        ...
        <p style="font-size: 14px; line-height: 160%;">
            {{$client_fullname}} has missed one or more medication intake for {{$date}}. Please login to the Rockgarden EHR’s dashboard to view the details.  <a href="{{$dashboard_link}}">{{$dashboard_link}}</a>
        </p>
    </div>
@endsection
